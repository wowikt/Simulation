...
namespace Simulation
{
    ...
    public static class Activators
    {
        ...
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAll(this List act)
        {
            ILink l = act.First;
            bool res = false;
            while (l != null)
        ...
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllAfter(this List act, ISchedulable act2)
        {
            ILink l = act.First;
            bool res = false;
            while (l != null)
        ...
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllAt(this List act, double t)
        {
            ILink l = act.First;
            bool res = false;
            while (l != null)
        ...
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllBefore(this List act, ISchedulable act2)
        {
            ILink l = act.First;
            bool res = false;
            while (l != null)
        ...
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllDelay(this List act, double dt)
        {
            ILink l = act.First;
            bool res = false;
            while (l != null)
        ...
        /// <param name="t">Время активации всех процессов из списка</param>
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllPriorAt(this List act, double t)
        {
            ISchedulable Prev = null;
            ILink l = act.First;
            bool res = false;
        ...
        /// <param name="dt">Задержка активации всех процессов из списка</param>
        /// <returns>true, если был активирован хотя бы один процесс или компонент</returns>
        public static bool ActivateAllPriorDelay(this List act, double dt)
        {
            ISchedulable Prev = null;
            ILink l = act.First;
            bool res = false;
        ...
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirst(this List act)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstAfter(this List act, ISchedulable act2)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <param name="t">Время активации процесса</param>
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstAt(this List act, double t)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstBefore(this List act, ISchedulable act2)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <param name="dt">Интервал времени для активации процесса</param>
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstDelay(this List act, double dt)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <param name="t">Время активации процесса</param>
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstPriorAt(this List act, double t)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <param name="dt">Интервал времени для активации процесса</param>
        /// <returns>true, если был активирован процесс или компонент</returns>
        public static bool ActivateFirstPriorDelay(this List act, double dt)
        {
            ISchedulable idleProc = act.FirstIdle();
            if (idleProc != null)
            {
        ...
        /// <returns>Первый пассивный процесс или компонент</returns>
        public static ISchedulable FirstIdle(this List act)
        {
            ILink l = act.First;
            while (l != null)
            {
        ...
        /// <param name="act">Список процессов и/или компонентов</param>
        /// <returns>Последний пассивный процесс или компонент</returns>
        public static ISchedulable LastIdle(this List act)
        {
            ILink l = act.Last;
            while (l != null)
            {
