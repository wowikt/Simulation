    ...
    public class SimulationDispatcher : Fiber
    {
        ...
        protected override void Run()
        {
            ...
            while (true)
            {
                ...
                // Если результат исполнения - ссылка на диспетчера, приостановить исполнение
                Console.WriteLine("Имитация прервана");
                Console.WriteLine(GetHashCode());
                Console.ReadLine();
                Global.CurrProc = null;
                Yield(null);
                Console.WriteLine("Имитация возобновляется");
                //Owner.VisProc.Resume();
                Console.WriteLine("Имитация возобновлена");
                Console.ReadLine();
            }
        }
    }
