...
// ќтображение очереди самосвалов с использованием разных символов
//   дл€ самосвалов разного типа
...
begin
  ...
  // ѕеребор самосвалов в очереди
  while trk <> nil do
  begin
    // ƒќбавить к строке очередной символ
